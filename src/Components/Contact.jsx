  ...
  return (
    <>
      ...
      <div className='flex max-sm:flex-col max-sm:gap-1 gap-10'>
        ...
        <Tilt className='mt-5 max-sm:w-full w-sm h-sm p-5 flex items-center border-2 border-orange-600 bg-orange-600 rounded-lg hover:bg-transparent hover:transition-colors'>
      ...
      <div className='flex max-sm:flex-col max-sm:gap-1 gap-10'>
        <Tilt className='mt-5 max-sm:w-full w-sm h-sm p-5 flex items-center border-2 border-blue-700 bg-blue-700 rounded-lg hover:bg-transparent hover:transition-colors'>
        ...
        <Tilt className='mt-5 max-sm:w-full w-sm h-sm p-5 flex items-center border-2 border-red-700 bg-red-700 rounded-lg hover:bg-transparent hover:transition-colors'>
