...
const Cp = () => {
    return (
        <div>
          ...
          >
            LEETCODE <br /> Secured max contest rating of 1620 at the top 20.73% globally and solved 500+ problems using Python.
          </motion.p>
          </a>
          ...
          >
            CODECHEF <br /> Secured contest rating of 1305 along with active participation and have solved over 250 problems.
          </motion.p>
          </a>
        </div>
    )
